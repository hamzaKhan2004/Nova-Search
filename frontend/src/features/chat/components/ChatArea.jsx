    ...
    return (
        <div className="mb-3 space-y-1.5">
            <div className="flex items-center gap-1.5 text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">
                <svg className="w-3.5 h-3.5 text-neutral-700 dark:text-neutral-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
        <div className="my-4 p-5 rounded-2xl border border-neutral-300 dark:border-neutral-800 bg-white/95 dark:bg-neutral-900/90 backdrop-blur-md text-xs shadow-md space-y-3.5 transition-all">
            ...
            <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2.5 pt-2 border-t border-neutral-100 dark:border-neutral-800/80">
                <button
                    type="button"
                    onClick={() => onCancel({ actionId: action.actionId, approved: false })}
                    disabled={isSending}
    ...
    const starterPrompts = [
        {
            ...
            prompt: "Explain the Node.js event loop, including microtask queue, macrotask queue, and phases with a clear diagram."
        },
        {
            title: "Compare React 19 vs Next.js",
            desc: "Architecture, Server Actions, and rendering paradigms",
            prompt: "Compare React 19 native features with Next.js App Router. What are the key architectural tradeoffs?"
        },
        {
            title: "Search recent AI releases",
            desc: "Live web search for latest AI model releases and benchmarks",
            prompt: "Search the latest news and releases in open source AI models this month."
        },
        {
            title: "Draft a project update email",
            desc: "Structured email for project stakeholders or team",
            prompt: "Draft an email to team@example.com proposing a new search feature and requesting feedback by Friday."
        }
    ];
                    ...
                    <div className="max-w-2xl mx-auto py-12 px-4 text-center space-y-6">
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400 max-w-md mx-auto leading-relaxed">
                                Search real-time web sources, write clean code, analyze problems, or draft and send emails.
                            </p>
                        </div>
                ...
                <div className="max-w-3xl mx-auto space-y-6 ">
                    {messages.map((msg, index) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`select-text max-w-[92%] sm:max-w-[80%] rounded-2xl px-4 py-3 text-sm ${isUser
                                        ? "bg-neutral-950 dark:bg-neutral-100 text-white dark:text-neutral-950 rounded-br-xs shadow-xs"
                                ...
                                >
                                    {isUser ? (
                                        <p className="select-text cursor-text whitespace-pre-wrap leading-relaxed">{msg.content}</p>
                                    ) : (
                                            ...
                                            <ReactMarkdown
                                                components={{
                                                    code({ inline, className, children, ...props }) {
                                                        if (inline) {
                                                            return (
                                                                <code className="px-1.5 py-0.5 rounded bg-neutral-200/80 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 font-mono text-xs" {...props}>
                                                                    {children}
                                                                </code>
                                                            );
                                                        }
                                ...
                                {!isUser && (
                                    <div className="flex items-center gap-1 mt-1 text-neutral-400 dark:text-neutral-500 text-xs">
                                        ...
                                        >
                                            {copiedIndex === index ? (
                                                <span className="text-neutral-900 dark:text-neutral-100 font-medium text-[11px]">Copied</span>
                                            ) : (
                                                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                                                </svg>
